        ...
        <div className="max-w-container mx-auto px-lg">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-lg">
            {awards.map((award, index) => {
              const certificatePath = t(`awards.list.${award}.certificatePath`, { defaultValue: `Recognition/Awards/${award}.png` });
                  ...
                  <ImageModal
                    ...
                    trigger={
                      <img
                        src={certificateUrl}
                        alt={t(`awards.list.${award}.title`)}
                        className="w-full aspect-[4/3] object-cover transition-all duration-700 group-hover:scale-105 cursor-pointer"
                        loading="lazy"
                      />
                    }
                  />
                  <div className="absolute inset-0 bg-primary-900/0 group-hover:bg-primary-900/10 transition-colors duration-normal pointer-events-none" />
                </div>
